...
outfile <- "R255X_E488QD_onehot_dummy_demeaned.csv"


# ============================================================================ #
# One-hot encode sequence data & demean it. T is set as the dummy variable.
...
wide_data <- long_data %>%
  ...
  mutate(across( #demean one-hot cols
    .cols = -N10, 
    .fns = ~ . - mean(.)
  ))
...
print(model_data)
write_csv(model_data, here(outdir, outfile))
